...
public class JwtService {
    private static final String SECRET_KEY = "C2B85B2B13A198A7A2CC67B488CF9CXA122EDSHFGTBFCHFFUJFGVFUJVT542357";
//    SecretKey SECRET_KEY = Keys.secretKeyFor(SignatureAlgorithm.HS256);
    ...
    public String generateToken(UserDetails userDetails){
     ...
     public boolean isTokenVaild( String token, UserDetails userDetails){
        final String  userPhoneNumber = extractUserName(token);
        return (userPhoneNumber.equals(userDetails.getUsername())) && !isTokenExprired(token);
     }
